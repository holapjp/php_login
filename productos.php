...
<html>
  ...
  <body>
    ...
    <div class="main-container">
              ...
              <?php
                ...
                foreach($datos as $d){?>
                  <tr>
                    ...
                    <td> <?= $d['cantidad']?> </td>
                    <td>
                      <a href="productos.php?id=<?= $d['id'] ?>" class="btn btn-info" data-toggle="modal" data-target="#ver"><i class="fas fa-eye"></i></a>
                      <a href="#" class="btn btn-warning" style="color:white;"><i class="fas fa-edit"></i></a>
                      <a href="#" class="btn btn-danger"> <i class="far fa-trash-alt"></i> </a>
                    </td>
                  </tr>
                <?php }
                require_once 'partial/modals.php';
               ?>
            </tbody>
          </table>
           </div>
      ...
      <div class="col">
        <div class="jumbotron" style="margin:20px; margin-left:0;">
          <div class="container">
